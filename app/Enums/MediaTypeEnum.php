...
enum MediaTypeEnum: string
{
    ...
    {
        return [
            self::IMAGE->value => (string) __('notify::whatsapp.media_types.image'),
            self::VIDEO->value => (string) __('notify::whatsapp.media_types.video'),
            self::DOCUMENT->value => (string) __('notify::whatsapp.media_types.document'),
            self::AUDIO->value => (string) __('notify::whatsapp.media_types.audio'),
        ];
    }
