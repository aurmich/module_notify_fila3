...
enum TelegramDriverEnum: string
{
    ...
    {
        return [
            self::TELEGRAM->value => (string) __('notify::telegram.drivers.telegram'),
            self::BOTAPI->value => (string) __('notify::telegram.drivers.botapi'),
            self::LARAVEL_TELEGRAM->value => (string) __('notify::telegram.drivers.laravel_telegram'),
        ];
    }
