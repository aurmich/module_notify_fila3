...
enum WhatsAppDriverEnum: string
{
    ...
    {
        return [
            self::TWILIO->value => (string) __('notify::whatsapp.drivers.twilio'),
            self::MESSAGEBIRD->value => (string) __('notify::whatsapp.drivers.messagebird'),
            self::VONAGE->value => (string) __('notify::whatsapp.drivers.vonage'),
            self::INFOBIP->value => (string) __('notify::whatsapp.drivers.infobip'),
        ];
    }
