    ...
    public static function getFormSchema(): array
    {
        return [
            Forms\Components\TextInput::make('name')
                ...
                ->helperText((string) __('notify::template.form.name.helper'))
                ->columnSpan(['lg' => 2]),

            Forms\Components\TextInput::make('subject')
                ->required()
                ->maxLength(255)
                ->helperText((string) __('notify::template.form.subject.helper'))
                ->columnSpan(['lg' => 2])
                ->translateLabel(),
            ...
            Forms\Components\Select::make('type')
                ...
                ->helperText((string) __('notify::template.form.type.helper'))
                ->columnSpan(['lg' => 1]),
            ...
            Forms\Components\Textarea::make('body_text')
                ...
                ->maxLength(65535)
                ->columnSpan(['lg' => 3])
                ->helperText((string) __('notify::template.form.body_text.helper'))
                ->rows(5)
                ->translateLabel(),
            ...
            Forms\Components\Textarea::make('body_html')
                ...
                ->maxLength(65535)
                ->columnSpan(['lg' => 3])
                ->helperText((string) __('notify::template.form.body_html.helper'))
                ->rows(10)
                ->translateLabel(),
            ...
            Forms\Components\Textarea::make('preview_data')
                ->json()
                ->columnSpan(['lg' => 3])
                ->helperText((string) __('notify::template.form.preview_data.helper'))
                ->rows(5),
            ...
            Forms\Components\SpatieMediaLibraryFileUpload::make('attachments')
                ...
                ->columnSpan(['lg' => 3])
                ->helperText((string) __('notify::template.form.attachments.helper')),
        ];
    }
