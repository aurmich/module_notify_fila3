 ...
 * @method static Contact|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Contact> get()
 * @method static Contact create(array $attributes = [])
 * @method static Contact firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Contact where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Contact whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
