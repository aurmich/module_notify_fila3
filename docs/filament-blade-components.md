# Standard SaluteOra: Componenti Blade Filament

In SaluteOra, la **prima scelta per i componenti Blade** sono SEMPRE i [componenti nativi Filament](https://filamentphp.com/docs/3.x/support/blade-components/overview).
