...
grep -r "interface.*Interface" --include="*.php" /var/www/html/<directory progetto>/laravel/Modules

# Cerca interfacce con naming corretto
grep -r "interface.*Contract" --include="*.php" /var/www/html/<directory progetto>/laravel/Modules
```

## Riferimenti

- [Laravel Contracts Documentation](https://laravel.com/docs/contracts)
- [<nome progetto> Code Quality Guidelines](/var/www/html/<directory progetto>/laravel/docs/code-quality.md)
- [Modulo Xot Contracts](/var/www/html/<directory progetto>/laravel/Modules/Xot/app/Contracts/)
