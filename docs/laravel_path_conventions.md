# Convenzioni dei Path in Laravel

## Regole Fondamentali per i Path di Cartelle

In Laravel, i nomi delle cartelle principali (come definite nella struttura standard) **DEVONO** rispettare il caso specifico definito dalle convenzioni di Laravel.
...
```
/var/www/html/project/laravel/Modules/Notify/resources/views/
```
...
// /var/www/html/project/laravel/Modules/Notify/resources/views/filament/pages/send-sms.blade.php
```
