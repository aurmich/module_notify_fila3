...
rm -f /var/www/html/<directory progetto>/laravel/Modules/Notify/lang/it/.php

# Rimozione dei file con nomi errati dopo aver verificato che esistano le versioni corrette
rm -f /var/www/html/<directory progetto>/laravel/Modules/Notify/lang/it/send_s_m_s.php
rm -f /var/www/html/<directory progetto>/laravel/Modules/Notify/lang/it/send_a_w_s_email.php
rm -f /var/www/html/<directory progetto>/laravel/Modules/Notify/lang/it/send_whats_app.php
rm -f /var/www/html/<directory progetto>/laravel/Modules/Notify/lang/it/send_netfun_s_m_s.php
```
