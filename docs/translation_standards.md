...
Questo documento definisce gli standard e le best practices per la gestione delle traduzioni all'interno dei moduli della piattaforma, con particolare attenzione al modulo Notify.
